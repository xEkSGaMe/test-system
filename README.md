...
| **🔐 Авторизация** | Go, JWT, OAuth2 | Иван К. | 🔄 В разработке | ███████░░░ 70% |
| **🌐 Веб-клиент** | Html | Иван С. | 📋 Планирование | ░░░░░░░░░░ 0% |
| **🤖 Telegram бот** | Python, aiogram | Артем | 🔄 В разработке | ████░░░░░░ 40% |
| **⚙️ C++ Модуль** | C++, алгоритмы, производительность | Меджит | ✅ Завершён | ██████████ 100% |
...
|:---:|:---:|:---:|:---:|:---:|
| Docker, PostgreSQL, MongoDB | Go, JWT, OAuth2 | Html | Python, aiogram | C++, алгоритмы |
...
### 📈 Общий прогресс
```mermaid
pie title Общий прогресс проекта (68%/100%)
    "Завершено" : 46
    "В работе" : 12
    "В планах" : 20
